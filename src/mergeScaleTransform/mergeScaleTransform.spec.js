...
describe(`$$mergeScaleTransform`, function () {
  ...
  // TODO
  describe.skip(`The matrix of the SVGTransform at index - 1 should have the values ({a: 1, b: 0, c: 0, d: 1}).`, function () {
    let transform_list;
    let index;
  ...
  // TODO
  describe.skip(`The matrix at index -1 and the matrix at index + 1 should satisfy the following conditions.`, function () {
    let transform_list;
    let index;
